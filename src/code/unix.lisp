...
(defun posix-getcwd ()
  ...
  ;; runtime to start up
  #!-(or android linux openbsd freebsd netbsd sunos osf1 darwin hpux win32 dragonfly hurd)
  #.(error "POSIX-GETCWD is not implemented.")
  (or
   #!+(or linux openbsd freebsd netbsd sunos osf1 darwin hpux win32 dragonfly hurd)
   (newcharstar-string (alien-funcall (extern-alien "getcwd"
                                                    (function (* char)
                                                              (* char)
                                                              size-t))
                                      nil
                                      #!+(or linux openbsd freebsd netbsd darwin win32 dragonfly hurd) 0
